...
#include "my_package_msgs/msg/detail/cmd_and_pose_vel__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_package_msgs::msg::CmdAndPoseVel & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_package_msgs::msg::CmdAndPoseVel & ros_message)
{
  // Member: cmd_vel_linear
  cdr >> ros_message.cmd_vel_linear;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_package_msgs::msg::CmdAndPoseVel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_package_msgs::msg::CmdAndPoseVel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_package_msgs::msg::CmdAndPoseVel *>(
    untyped_ros_message);
...
{
  return &my_package_msgs::msg::typesupport_fastrtps_cpp::_CmdAndPoseVel__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_package_msgs, msg, CmdAndPoseVel)() {
  return &my_package_msgs::msg::typesupport_fastrtps_cpp::_CmdAndPoseVel__handle;
}

...
static const _CmdAndPoseVel_type_support_symbol_names_t _CmdAndPoseVel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_package_msgs, msg, CmdAndPoseVel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_package_msgs, msg, CmdAndPoseVel)),
  }
};
...
{
  return &::my_package_msgs::msg::rosidl_typesupport_cpp::CmdAndPoseVel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_package_msgs, msg, CmdAndPoseVel)() {
  return get_message_type_support_handle<my_package_msgs::msg::CmdAndPoseVel>();
}

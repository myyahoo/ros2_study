...
bool my_package_msgs__msg__cmd_and_pose_vel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_package_msgs.msg._cmd_and_pose_vel.CmdAndPoseVel", full_classname_dest, 51) == 0);
  }
  my_package_msgs__msg__CmdAndPoseVel * ros_message = _ros_message;
  {  // cmd_vel_linear
...
PyObject * my_package_msgs__msg__cmd_and_pose_vel__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_package_msgs.msg._cmd_and_pose_vel");
